      ...
      <div className="modal-content">
        ...
        <div className="modal-body">
          ...
          <div className="modal-project-details modal-project-card">
            ...
            <div className="modal-project-languages">
              {/* Ici, vous allez mapper sur les langages pour afficher les logos */}
        ...
        <div className="modal-footer">
          <a href={project.url} target="_blank" rel="noopener noreferrer">
            <button className="project-view-button">Voir le site</button>
          </a>
...
ProjectModal.propTypes = {
  ...
  project: PropTypes.shape({
    ...
    url: PropTypes.string.isRequired, // url doit être une chaîne obligatoire
  }).isRequired,
};
